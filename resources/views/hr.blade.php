  ...
  <main id="main">
    ...
    <div class="hr-overlay">
      <div class="container text-center">
        <h1>Human Rights</h1>
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px">Advancing International Human Rights to Protect against Discrimination Based on Sexual Orientation and Gender Identity</p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px">The Impacts of Unilateral Coercive Measures on the Protection and Enjoyment of Human Rights</p>
      </div>
    </div>
      ...
      <section id="des">
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">The Council was created by the United Nations General Assembly on 15 March 2006. The Human Rights Council is an inter-governmental body within the United Nations system responsible for strengthening the promotion and protection of human rights around the globe and for addressing situations of human rights violations and make recommendations on them. It has the ability to discuss all thematic human rights issues and situations that require its attention throughout the year. It meets at the UN Office at Geneva.</p>
          </div>
        </div>
        ...
        <div class="row align-items-md-stretch">
          <div class="col-md-6">
            <div class="h-100 p-5 text-white bg-dark rounded-3">
              ...
              <br>
              <a href="/assets/background_papers/hr/a.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <img src="/assets/img/chairs/hr.jpg" alt="" class="img-fluid rounded mx-auto d-block img-thumbnail">
