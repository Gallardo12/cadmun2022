...
<head>
  ...
  <title>CADMUN 2022 - SPECPOL</title>
  ...
  <main id="main">
    ...
    <div class="specpol-overlay">
      <div class="container text-center">
        ...
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px">The decolonization of Western Sahara </p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px">Reviewing the ongoing crisis in Kashmir</p>
      </div>
    </div>
      ...
      <section id="des">
        ...
        <div class="row align-items-md-stretch">
          <div class="col-md-6">
            <div class="h-100 p-5 text-white bg-dark rounded-3">
              ...
              <br>
              <a href="/assets/background_papers/specpol/a.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
              <a href="/assets/background_papers/specpol/b.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC B</button></a>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <img src="/assets/img/chairs/specpol.jpg" alt="" class="img-fluid rounded mx-auto d-block img-thumbnail">
