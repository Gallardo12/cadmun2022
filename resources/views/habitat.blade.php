...
<head>
  ...
  <title>CADMUN 2022 - UN-Habitat</title>
  ...
  <main id="main">
    ...
    <div class="habitat-overlay">
      <div class="container text-center">
        ...
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px">Drastically Reducing Maritime Pollution, including plastics</p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px">Pollution Caused By The Food Industry</p>
      </div>
    </div>
      ...
      <section id="des">
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">The UN-Habitat’s vision of “a better quality of life for all in an urbanizing world” is bold and ambitious. UN-Habitat works with partners to build inclusive, safe, resilient and sustainable cities and communities. UN-Habitat promotes urbanization as a positive transformative force for people and communities, reducing inequality, discrimination and poverty. UN-Habitat works in over 90 countries to promote transformative change in cities and human settlements through knowledge, policy advice, technical assistance and collaborative action.</p>
          </div>
        </div>
        ...
        <div class="row align-items-md-stretch">
          <div class="col-md-6">
            <div class="h-100 p-5 text-white bg-dark rounded-3">
              ...
              <br>
              <a href="/assets/background_papers/habitat/a.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
              <a href="/assets/background_papers/habitat/b.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC B</button></a>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <img src="/assets/img/chairs/habitat.jpg" alt="" class="img-fluid rounded mx-auto d-block img-thumbnail">
