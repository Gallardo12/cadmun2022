...
<head>
  ...
  <title>CADMUN 2022 - SOCHUM</title>
  ...
  <main id="main">
    ...
    <div class="sochum-overlay">
      <div class="container text-center">
        ...
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px">An International Push for the Ending of Human Trafficking</p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px">Addressing Criminal Rehabilitation and its Effects on Society</p>
      </div>
    </div>
      ...
      <section id="des">
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">The Social, Humanitarian, and Cultural Committee (SOCHUM) is the Third Committee of the General Assembly that is specially tasked with addressing a wide range of social and humanitarian affairs as well as human rights issues. Some of the goals of SOCHUM include the advancement of women, the protection of children, the access to free speech, the treatment of refugees, the promotion of fundamental freedoms through the elimination of racism and racial discrimination, and the promotion of the right to self-determination. The Third Committee has delegated a portion of these responsibilities to its sub-committee, the United Nations Human Rights Council (UNHRC), which reports back to the General Assembly on matters related to human rights.</p>
          </div>
        </div>
