      ...
      <section id="des">
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">The Commission on Narcotic Drugs (CND) was established by Economic and Social Council (ECOSOC) resolution 9(I) in 1946, to assist the ECOSOC in supervising the application of the international drug control treaties. In 1991, the General Assembly (GA) expanded the mandate of the CND to enable it to function as the governing body of the UNODC. ECOSOC resolution 1999/30 requested the CND to structure its agenda with two distinct segments: a normative segment for discharging treaty-based and normative functions; and an operational segment for exercising the role as the governing body of UNODC.</p>
          </div>
        </div>
