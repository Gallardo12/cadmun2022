    ...
    <main id="main">
        ...
        <div class="ad-overlay">
            <div class="container text-center">
                ...
                <p style="font-size: 20px">Taking action against the economic inflation post-COVID 19</p>
                <p style="color:red; font-size: 25px">TOPIC B:</p>
                <p style="font-size: 20px">Discussing Measures to Stop Nuclear Proliferation</p>
            </div>
        </div>
            ...
            <section id="des">
                ...
                <div class="p-5 mb-4 bg-dark rounded-3">
                    <div class="container-fluid py-5 bg-dark">
                        ...
                        <p style="text-align: justify;">Through its resolution 74/247, the General Assembly decided to
                            ...
                            information and communications technologies for criminal purposes, taking into full
                            consideration existing international instruments and efforts at the national, regional and
                            international levels on combating the use of information and communications technologies for
                            criminal purposes, in particular the work and outcomes of the open-ended intergovernmental
                            Expert Group to Conduct a Comprehensive Study on Cybercrime.</p>
                    </div>
                </div>
                ...
                <div class="row align-items-md-stretch">
                    <div class="col-md-6">
                        <div class="h-100 p-5 text-white bg-dark rounded-3">
                            ...
                            <br>
                            <a href="/assets/background_papers/ad/a.pdf" target="_blank"><button
                                    class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
                            <a href="/assets/background_papers/ad/b.pdf" target="_blank"><button
                    ...
                    <div class="col-md-6">
                        <div class="h-100 p-5 bg-dark border rounded-3">
                            ...
                            <a href="	mailto:ad.hoc@cadmun.org" target="_blank"><button class="btn btn-outline-light"
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        <div
                            ...
                            <img src="/assets/img/chairs/adhoc.jpg" alt=""
