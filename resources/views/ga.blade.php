    ...
    <main id="main">
        ...
        <div class="ga-overlay">
            <div class="container text-center">
                ...
                <p style="font-size: 20px">Countering the Threat Posed by Improvised Explosive Devices</p>
                <p style="color:red; font-size: 25px">TOPIC B:</p>
                <p style="font-size: 20px">Implementing the Paris Declaration on Aid effectiveness and the Accra Agenda
                    for Action</p>
            </div>
        </div>
            ...
            <section id="des">
                ...
                <div class="p-5 mb-4 bg-dark rounded-3">
                    <div class="container-fluid py-5 bg-dark">
                        ...
                        <p style="text-align: justify;">Founded in 1945, the United Nations General Assembly is the main
                            organ of
                            the UN. It is
                            considered the democratic heart of the United Nations, it serves as the main deliberative,
                            policymaking,
                            and representative body. The General Assembly has debates of peace, security, development,
                            human rights,
                            among others. This committee has huge relevance and influence, since key decisions that
                            affect all 193
                            Member States are made. The General Assembly has the authority to approve or not a
                            resolution made by
                            another committee. It requires the best and most prepared delegates that will be able to
                            analyze
                ...
                <div class="row align-items-md-stretch">
                    <div class="col-md-6">
                        <div class="h-100 p-5 text-white bg-dark rounded-3">
                            ...
                            <br>
                            <a href="/assets/background_papers/ga/a.pdf" target="_blank"><button
                                    class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
                            <a href="/assets/background_papers/ga/b.pdf" target="_blank"><button
                    ...
                    <div class="col-md-6">
                        <div class="h-100 p-5 bg-dark border rounded-3">
                            ...
                            <a href="mailto:general.assembly@cadmun.org" target="_blank"><button
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        <div
                            ...
                            <img src="/assets/img/chairs/ga.jpg" alt=""
