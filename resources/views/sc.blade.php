  ...
  <main id="main">
    ...
    <div class="sc-overlay">
      <div class="container text-center">
        ...
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px"> The Situation in the Middle East, including the Palestinian Question</p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px"> TOPIC B: Measures to Strengthen International </p>
      </div>
    </div>
    ...
    <div class="container py-4">
      <section id="des">
        ...
        <div class="pb-3 mb-4 border-bottom">
          <p style="font-size: 30px; text-align: center; background-color:#224ff2 "> BLUE DIVISION (9TH GRADE - 12TH
            GRADE)</p>
        </div>
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">The Security Council has primary responsibility for the maintenance of international peace and security. Under the Charter of the United Nations, all Member States are obligated to comply with Council decisions. The Security Council takes the lead in determining the existence of a threat to the peace or act of aggression. It calls upon the parties to a dispute to settle it by peaceful means and recommends methods of adjustment or terms of settlement. In some cases, the Security Council can resort to imposing sanctions or even authorize the use of force to maintain or restore international peace and security.</p>
          </div>
        </div>
        ...
        <div class="row align-items-md-stretch">
          <div class="col-md-6">
            <div class="h-100 p-5 text-white bg-dark rounded-3">
              ...
              <br>
              <a href="/assets/background_papers/sc/a.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
              <a href="/assets/background_papers/sc/b.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC B</button></a>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <img src="/assets/img/chairs/sc.jpg" alt="" class="img-fluid rounded mx-auto d-block img-thumbnail">
