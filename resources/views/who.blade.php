  ...
  <main id="main">
    ...
    <div class="who-overlay">
      <div class="container text-center">
        ...
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px">Equitable vaccine distribution</p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px">Should medications be tested on animals?</p>
      </div>
    </div>
      ...
      <section id="des">
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">Founded in 1948, WHO is the United Nations agency that connects nations, partners and people to promote health, keep the world safe and serve the vulnerable – so everyone, everywhere can attain the highest level of health. WHO leads global efforts to expand universal health coverage. We direct and coordinate the world’s response to health emergencies. And we promote healthier lives – from pregnancy care through old age. Our Triple Billion targets outline an ambitious plan for the world to achieve good health for all, using science-based policies and programmes. </p>
          </div>
        </div>
        ...
        <div class="row align-items-md-stretch">
          <div class="col-md-6">
            <div class="h-100 p-5 text-white bg-dark rounded-3">
              ...
              <br>
              <a href="/assets/background_papers/who/a.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
              <a href="/assets/background_papers/who/b.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC B</button></a>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <img src="/assets/img/chairs/who.jpg" alt="" class="img-fluid rounded mx-auto d-block img-thumbnail">
