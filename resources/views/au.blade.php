  ...
  <main id="main">
    ...
    <div class="au-overlay">
      <div class="container text-center">
        <h1>African Union</h1>
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px">Maleducation of children and consequent child labor</p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px">Hunger and poverty in the AU</p>
      </div>
    </div>
      ...
      <section id="des">
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">The African Union (AU) was officially launched in July 2002 in Durban, South Africa, following a decision in September 1999 by its predecessor, the OAU to create a new continental organisation to build on its work. The decision to re-launch Africa’s pan-African organisation was the outcome of a consensus by African leaders that in order to realise Africa’s potential, there was a need to refocus attention from the fight for decolonisation and ridding the continent of apartheid, which had been the focus of the OAU, towards increased cooperation and integration of African states to drive Africa’s growth and economic development.</p>
          </div>
        </div>
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <img src="/assets/img/chairs/au.jpg" alt="" class="img-fluid rounded mx-auto d-block img-thumbnail">
          ...
          <div class="col-md-6">
            <div class="row g-0 rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              ...
              <div class="col p-4 d-flex flex-column position-static" style = "text-align: center">
                ...
                <h3 class="mb-0">Carlos Talamas</h3>
              </div>
