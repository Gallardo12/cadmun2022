  ...
  <main id="main">
    ...
    <div class="iom-overlay">
      <div class="container text-center">
        ...
        <br><br>
        <p style = "color:red; font-size: 25px" >TOPIC A:</p> <p style = "font-size: 20px">Improving attitudes towards immigrants and refugees </p>
        <p style = "color:red; font-size: 25px" >TOPIC B:</p> <p style = "font-size: 20px">Access to healthcare for migrants in conflict zones </p>
      </div>
    </div>
      ...
      <section id="des">
        ...
        <div class="p-5 mb-4 bg-dark rounded-3">
          <div class="container-fluid py-5 bg-dark">
            ...
            <p style="text-align: justify;">Established in 1951, IOM is the leading intergovernmental organization in the field of migration and works closely with governmental, intergovernmental and non-governmental partners. With 174 member states, a further 8 states holding observer status and offices in over 100 countries, IOM is dedicated to promoting humane and orderly migration for the benefit of all. It does so by providing services and advice to governments and migrants.</p>
          </div>
        </div>
        ...
        <div class="row align-items-md-stretch">
          <div class="col-md-6">
            <div class="h-100 p-5 text-white bg-dark rounded-3">
              ...
              <br>
              <a href="/assets/background_papers/iom/a.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC A</button></a>
              <a href="/assets/background_papers/iom/b.pdf" target = "_blank"><button class="btn btn-outline-light" type="button">View PDF for TOPIC B</button></a>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <img src="/assets/img/chairs/iom.jpg" alt="" class="img-fluid rounded mx-auto d-block img-thumbnail">
          ...
          <div class="col-md-6">
            <div class="row g-0 rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              ...
              <div class="col p-4 d-flex flex-column position-static" style = "text-align: center">
                ...
                <h3 class="mb-0">Sofia Victoria</h3>
              </div>
